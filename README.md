![](https://www.avinashghare.com/_nuxt/img/241480c.png) FrameWork
-------------
#### To Run This Application Follow The Steps Below : 
```sh
$ git clone https://github.com/avinashghare/framework
```
```sh 
$ cd  framework/
```
...
```sh
docker buildx build -t github.com/avinashghare/framework .
```
